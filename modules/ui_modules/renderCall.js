    ...
    const callHtml = `
        <div class="call-ui-internal">
            ...
            <div class="call-controls">
                <button class="control-button record-call-btn" title="录音"><i class="fas fa-dot-circle"></i></button>
                <button class="control-button voice-input-btn" title="说话"><i class="fas fa-microphone"></i></button>
                <button class="control-button end-call" title="挂断"><i class="fas fa-phone"></i></button>
            </div>
        </div>`;
