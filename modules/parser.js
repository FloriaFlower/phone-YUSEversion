...
export const PhoneSim_Parser = {
    ...
    parseCommand: function(r) {
            ...
            try {
                ...
                if (type === '新动态') {
                    ...
                    return {
                        ...
                        app: '微信',
                        type: '新动态',
                        momentId: jsonData.动态id,
                        posterId: jsonData.发布者id,
                        posterName: jsonData.发布者昵称,
                        time: jsonData.time,
                        content: this._parseContent(jsonData.内容 || ''),
                        images: jsonData.图片 || [],
                        location: jsonData.地点,
                        likes: jsonData.点赞 || [],
        ...
        if (finalMessage.app === '浏览器' && params.type === '搜索目录') {
            return {
                commandType: 'Browser',
                app: '浏览器',
                type: '搜索目录',
        ...
        if (finalMessage.app === '微信') {
             if (params.type === '私聊') {
                if (params.from_id && params.to_id) {
                    ...
                    finalMessage.senderId = params.id;
        ...
        if (finalMessage.app === '电话' && params.type === '电话') {
